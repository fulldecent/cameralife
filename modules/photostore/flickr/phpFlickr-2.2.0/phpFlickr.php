...
class phpFlickr
{
    public $api_key;
    public $secret;
    public $REST = 'http://api.flickr.com/services/rest/';
    public $Upload = 'http://api.flickr.com/services/upload/';
    public $Replace = 'http://api.flickr.com/services/replace/';
    public $req;
    public $response;
    ...
    */
    ...
    public function photos_getNotInSet($min_upload_date = NULL, $max_upload_date = NULL, $min_taken_date = NULL, $max_taken_date = NULL, $privacy_filter = NULL, $extras = NULL, $per_page = NULL, $page = NULL)
    {
    ...
    public function photos_getUntagged($min_upload_date = NULL, $max_upload_date = NULL, $min_taken_date = NULL, $max_taken_date = NULL, $privacy_filter = NULL, $extras = NULL, $per_page = NULL, $page = NULL)
    {
    ...
    public function photos_getWithGeoData($args = NULL)
    {
    ...
    public function photos_getWithoutGeoData($args = NULL)
    {
        /* See the documentation included with the photos_search() function.
         * I'm using the same style of arguments for this function. The only
         * difference here is that this doesn't require any arguments. The
    ...
    public function photos_recentlyUpdated($min_date = NULL, $extras = NULL, $per_page = NULL, $page = NULL)
    {
        /* http://www.flickr.com/services/api/flickr.photos.getUntagged.html */
        if (is_array($extras)) {
            $extras = implode(",", $extras);
    ...
    public function photos_setSafetyLevel ($photo_id, $safety_level, $hidden = null)
    {
    ...
    public function photos_comments_getList($photo_id)
    {
    ...
    public function photosets_getPhotos($photoset_id, $extras = NULL, $privacy_filter = NULL, $per_page = NULL, $page = NULL)
    {
    ...
    public function tags_getListUserRaw($tag)
    {
