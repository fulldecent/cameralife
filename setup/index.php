...
if (md5($data) == 'accba0b69f352b4c9440f05891b015c5') {
    ...
    $fixes[] = array(
        'Ubuntu' => "Your server doesn't appear to support
...
if (file_exists('../.htaccess') && !is_writable('../.htaccess')) {
    $checkPrerequesites[] = array(
        'desc' => 'Your file <code>.htaccess</code> exists but is not writable. Please fix this now, or you will have to edit the file manually later',
        'type' => 'warning'
    );
    ...
    $checkPrerequesites[] = array(
        'desc' => 'We cannot automatically edit .htaccess. Please fix this now, or you will have to edit the file manually later.',
        'type' => 'warning'
    );
    $fullDir = dirname(dirname(__FILE__)) . '/.htaccess';
    $fixes[] = array(
...
if (file_exists('.htaccess')) {
    ...
    $checkPrerequesites[] = array(
        'desc' => 'Your <code>.htaccess</code> did not unpack from the zipball/tarball properly',
        'type' => 'danger'
    );
    $fixes[] = array(
...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            ...
            ?>
            You must fix prerequisite errors before continuing <a class="btn btn-primary" href=""><i
