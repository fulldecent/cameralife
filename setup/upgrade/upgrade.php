...
<head>
  ...
  <style type="text/css">body{width: 960px; background: #eee; margin: 2em auto} </style>
</head>
<body>
<h1>Camera Life Database Updater Utility</h1>
<p>The installed version of the database schema is <?php echo $installed_version ?>. The needed version is <?php echo $latest_version ?>.
