...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            ...
            <p><a href="../" target="_blank">Open your site</a> and login with OpenID. Then promote your account to an
                admin account.</p>
        ...
        <div class="col-sm-4">
            ...
            <ul>
                ...
                <li>Change your <a href="../admin/fileStore.php" target="_blank">File Storage setup</a> to use Amazon
                    S3, or Flickr, or remote FTP storage (advanced)
                </li>
            </ul>
        </div>
        <div class="col-sm-4">
    ...
    <div class="well">
        <h2>
            You're done
            <a class="btn btn-primary btn-large" href="../index.php" target="_blank"><i
