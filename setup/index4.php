...
<div class="jumbotron">
    ...
    <div class="container">
        ...
        if (!isset($_POST['sitepasswd'])) {
            ...
            <form class="form-inline" role="form" method="POST">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="sitepassword" placeholder="Site password"
                           name="sitepasswd">
                </div>
        ...
        <?php
            ...
            $error = '';
            if ($count == 1) {
                $error = 'You have not set up a user account to promote';
            }
            if ($count > 2) {
                $error = 'This tool only works for the first user on the system';
            }
            if ($pass != crypt($_POST['sitepasswd'], 'admin')) {
                $error = 'Site password not correct';
            }
